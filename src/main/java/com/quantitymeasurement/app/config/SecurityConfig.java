...
/**
 * Basic security configuration allowing all requests and configuring CORS.
 * Disables CSRF as this is a stateless REST API.
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            .csrf(csrf -> csrf.disable()) // DISABLE CSRF: Required for REST APIs
